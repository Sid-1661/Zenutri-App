                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text('\$95.10 AUD', style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                fontSize: 16.rSp,
                                color: AppColors.shadowGray
                              ),),
                              Wrap(
                                ...
                                children: [
                                  ...
                                  Text('(120)', style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                                      fontSize: 16.rSp,
                          ...
                          verticalSpace(22),
                          ExpansionTile(
                            title: Text('Description', style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                          ...
                          ExpansionTile(
                            title: Text('What’s included', style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                              color: AppColors.black
                            ),),
                            tilePadding: EdgeInsets.zero,
                            collapsedShape: Border(
